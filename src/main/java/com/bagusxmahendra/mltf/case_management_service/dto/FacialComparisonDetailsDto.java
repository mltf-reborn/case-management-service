...
public class FacialComparisonDetailsDto {
    ...
    private LivenessCheckResultDto livenessCheck;
    ...
    private String recommendation = "APPROVE";

    public FacialComparisonDetailsDto() {
    }

    public FacialComparisonDetailsDto(boolean faceDetectedInId, boolean faceDetectedInSelfie, boolean facialLandmarksMatch,
                                      List<String> matchingFeatures, List<String> discrepantFeatures,
                                      LivenessCheckResultDto livenessCheck, String riskLevel, String recommendation) {
    ...
    public LivenessCheckResultDto getLivenessCheck() {
        return livenessCheck;
    }

    public void setLivenessCheck(LivenessCheckResultDto livenessCheck) {
        this.livenessCheck = livenessCheck;
    }
